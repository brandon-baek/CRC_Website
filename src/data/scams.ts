...
export const scamGuides: ScamGuide[] = [
  ...
  },
  {
    ...
    tagline: {
      en: 'A scary pop-up says your computer is infected — but the only virus is the phone number on the screen.',
  ...
  },
  {
    ...
    protect: {
      en: [
        ...
        'Give out your Social Security number only when truly required — ask "do you really need it?"',
  ...
  },
  {
    ...
    ifHappened: {
      en: [
        'Contact your credit card company or bank right away and dispute the charge — do this even if the seller promises a refund "soon."',
